document.addEventListener("DOMContentLoaded", function(){
    ...
    function updateSelectedOptions(customSelect){
        const selectedOptions = Array.from(customSelect.
            querySelectorAll( ".option.active" )).filter(option => option !== customSelect.querySelector(".option.all-tags")).map(function(option){
                return{
    ...
    document.addEventListener("click", function(event){
        ...
        if(removeTag){
            const customSelect = removeTag.closest(".custome-select");
            const valueRemove = removeTag.getAttribute(".data-value");
